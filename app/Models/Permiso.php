...
class Permiso extends Model
{
     ...
     * @return array
     */
    function busquedaUsuarios($persona=0, $nombre='', $usuario='', $puesto='')
    {
     ...
     * @return string
     */
    function validaPermisoUsuario($idUsuario = 0, $idObjeto = 0)
    {
     ...
     * @return string
     */
    function validaPermisoUsuarioClub($idUsuario, $idUn)
    {
        settype($idUsuario, 'integer');
     ...
     * @return string
     */
    function validaPermisoPuesto ($idPuesto = 0, $idObjeto = 0)
    {
        $checked = '';
     ...
     * @return boolean
     */
    function guardarPorPuesto($puesto = 0, $objeto = 0, $estatus = 0)
    {
     ...
     * @return boolean
     */
    function guardarPorUsuario($usuario = 0, $objeto = 0, $estatus = 0)
    {
     ...
     * @return boolean
     */
    function validaTodosPermisos($idObjeto = 0)
    {
        settype($idObjeto, 'integer');
        $pase = false;
     ...
     * @return void
     */
    function log ($accion, $categoriaLog, $membresia = 0, $persona = 0, $regresaId = false, $idProducto = 0, $idUsuario = 0)
    {
     ...
     * @return boolean
     */
    function validaAdmin($idUsuario = 0)
    {
        $admin = false;
     ...
     *
      * @return array
      */
    function obtenPuestoUsuario($idUsuario = 0)
    {
        $data = array();
     ...
     * @return integer
     */
    function obtenNumeroEmpleado($idUsuario = 0)
    {
        $idEmpleado = 0;
     ...
     * @return integer
     */
     function usuariosAuto($nombre = "", $numeroRegistros = 25, $idPersona = 0 )
    {
    ...
    function puestoAuto($nombre = "", $numeroRegistros = 25, $idPersona = 0 )
    {
     ...
     * @return boolean
     */
    function guardarPorUsuarioClub($usuario = 0, $objeto = 0, $estatus = 0)
    {
        settype($usuario, 'integer');
        settype($objeto, 'integer');
        settype($estatus, 'integer');
     ...
     * @return boolean
     */
    function listaActivosXpermiso($idEmpresa = 0, $todos = false, $allocation = 0, $admonCentral =0)
    {
        $lista = array();
        $lista['0'] = '';
     ...
     * @return boolean
     */
    function validaPermisoCategoria ($idCategoria)
    {
     ...
     * @return array
     */
    function listaPermisoPuestos($opciones, $totales=0, $posicion=0, $registros=25, $orden = '')
    {
        if ($registros == 0) {
     ...
     * @return array
     */
    function guardaPermisoPuestos($puesto, $objeto)
    {
        settype($puesto, 'integer');
        settype($objeto, 'integer');
     ...
     * @return array
     */
    function datosPermisosPuestos($idPermisoAplicaPuestos)
    {
     ...
     * @return array
     */
    function guardaEdicionPermisoPuestos($idPermisoAplicaPuestos,$puesto, $objeto)
    {
        settype($puesto, 'integer');
        settype($objeto, 'integer');
        settype($idPermisoAplicaPuestos, 'integer');
     ...
     * @return array
     */
    function eliminarPermisoPuestos($idPermisoAplicaPuestos)
    {
        settype($idPermisoAplicaPuestos, 'integer');
     ...
     * @return boolean
     */
    function validaRevisorCategoria ($idCategoria, $tipo = '')
    {
        settype($idCategoria, 'integer');
        settype($tipo, 'string');
